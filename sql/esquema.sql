-- Cofre de Senhas Corporativo — esquema do banco (Supabase / PostgreSQL)
-- Executar integralmente no SQL Editor do projeto Supabase.
...
-- ---------------------------------------------------------------------------
-- Políticas de acesso (permissão ampla intencional — ver Seção 8.3)
-- ---------------------------------------------------------------------------
...
-- Garante acesso da Data API mesmo em projetos criados com
-- "Automatically expose new tables" desmarcado.
grant usage on schema public to anon;
grant select, insert, update, delete
  on public.cofres, public.segredos to anon;
